  ...
  return {
    ...
    quality_contract: {
      ...
      early_stop_conditions: [
        ...
        "text layout proof detects overflow, unsafe zones, or dense localized copy without proof",
        "marketing QA detects fake scene/use-case imagery made from vector backgrounds, repeated patterns, or product-card pasteups",
    ...
    progress_update_policy: {
      ...
      write_phase_trace_file: "telemetry/phase-trace.json",
      phase_trace_command: "node scripts/production-phase-tracer.mjs --run-dir <run-dir>",
      phase_spans_to_collect: [
        "source_preflight_ms",
        "planning_ms",
        "provider_total_ms",
